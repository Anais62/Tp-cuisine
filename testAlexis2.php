...
//         }
//     } else {
//        echo "<div class='center-container2'><h1 class='center-text'>Aucune recette disponible</h1></div>";
//     }
// }
?>
...
if (isset($_GET['id'])) {
    ...
    if ($recipe = $query->fetch(PDO::FETCH_ASSOC)) {
        ...
        $sqlRatings = "SELECT rating_value FROM rating2 WHERE recipe_id = :recipe_id";
       ...
       // Vérifier si l'utilisateur est connecté
        if (isset($_SESSION['logged']) && $_SESSION['logged'] === true) {
            ...
            $user_id = $_SESSION['id'];
            $existing_rating_sql = "SELECT * FROM rating2 WHERE user_id = :user_id AND recipe_id = :recipe_id";
            ...
            if ($existing_rating_query->rowCount() > 0) {
                ...
                if ($_SERVER["REQUEST_METHOD"] == "POST") {
                    ...
                    if ($existing_rating_query->rowCount() > 0) {
                        ...
                        $insert_rating_sql = "INSERT INTO rating2 (user_id, recipe_id, rating_value, timestamp) VALUES (:user_id, :recipe_id, :rating, CURRENT_TIMESTAMP)";
